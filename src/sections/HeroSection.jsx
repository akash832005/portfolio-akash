      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }} className="space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a href="/akash_fullstack.pdf" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-5 py-3 font-semibold text-slate-100 backdrop-blur transition hover:border-cyan-400/40 hover:text-cyan-300">
